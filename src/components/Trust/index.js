...
function Trust() {
  return (
    <div className="trust-wrapper flex absolute-center">
      <div className="max-width flex trust">
        
        <div className="trust-heading-wrapper flex">
          <div className="trust-heading">
            the story of CRED begins with trust.
          </div>
        </div>

        <div className="trust-story-details">
          <div className="trust-story-para">
